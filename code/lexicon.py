...
# ---------------------------------------------------------------------------
# PUNCTUATION-NORMALISED RATE HELPERS  (added 2026-09-21, fixes P0 audit)
# ---------------------------------------------------------------------------
# The full collections (全唐诗 / 御定全唐诗 / 全宋诗) retain ~14-16% CBETA-style
# punctuation in their paragraph text, whereas the selection editions
# (御選宋詩 / 宋詩鈔) were parsed with punctuation already stripped.  Normalising
# the per-1000-CHAR rate by a denominator that *includes* punctuation therefore
# inflates the selection-side rates by ~15% relative to the collection side.
#
# Fix: the denominator is the number of CONTENT characters (punctuation removed).
# The lexicon is still counted on the ORIGINAL text (punctuation never matches a
